...
OBJECTS			:= $(OBJ_DIR)/$(MAIN_FILE).o $(OBJ_DIR)/$(STARTUP).o $(OBJ_DIR)/$(SYSTEM).o $(OBJ_DIR)/System.o $(OBJ_DIR)/LCD.o $(OBJ_DIR)/ST7735.o $(OBJ_DIR)/Speaker.o $(OBJ_DIR)/Keypad.o $(OBJ_DIR)/MultipurposeKnob.o $(OBJ_DIR)/I2C.o $(OBJ_DIR)/Motor.o $(OBJ_DIR)/SevenSegment.o
######################################
...
$(OBJ_DIR)/$(MAIN_FILE).out: . $(OBJECTS)
	...
	$(CC) $(LDFLAGS) $(word 2,$^) $(OBJ_DIR)/$(STARTUP).o $(OBJ_DIR)/$(SYSTEM).o $(OBJ_DIR)/System.o $(OBJ_DIR)/LCD.o $(OBJ_DIR)/ST7735.o $(OBJ_DIR)/Speaker.o $(OBJ_DIR)/Keypad.o $(OBJ_DIR)/MultipurposeKnob.o $(OBJ_DIR)/I2C.o $(OBJ_DIR)/Motor.o $(OBJ_DIR)/SevenSegment.o -o $@ $(INCLUDES)
