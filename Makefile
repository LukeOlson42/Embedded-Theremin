...
OBJECTS			:= $(OBJ_DIR)/$(MAIN_FILE).o $(OBJ_DIR)/$(STARTUP).o $(OBJ_DIR)/$(SYSTEM).o $(OBJ_DIR)/System.o
######################################
...
$(OBJ_DIR)/$(MAIN_FILE).out: . $(OBJECTS)
	...
	$(CC) $(LDFLAGS) $(word 2,$^) $(OBJ_DIR)/$(STARTUP).o $(OBJ_DIR)/$(SYSTEM).o $(OBJ_DIR)/System.o -o $@ $(INCLUDES)
